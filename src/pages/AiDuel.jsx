    ...
    <section className="flex flex-col gap-6 sm:gap-8 md:gap-10">
      <div className="flex flex-col gap-3 sm:gap-4">
        ...
        <p className="max-w-3xl text-sm sm:text-base leading-relaxed text-textSecondary">
          Play a five-round match against GeoAI, powered by <code className="text-xs bg-background/60 px-1.5 py-0.5 rounded border border-white/10">mistral-small-3.2-24b-instruct</code> (and <code className="text-xs bg-background/60 px-1.5 py-0.5 rounded border border-white/10">llama-4-scout</code> or <code className="text-xs bg-background/60 px-1.5 py-0.5 rounded border border-white/10">polaris-alpha</code> upon error): guess the country from the image,
